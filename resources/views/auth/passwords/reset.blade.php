                    ...
                    <form class="text-left" action="{{ route('password.update') }}" method="POST" id="formReset">
                        ...
                        <div class="form">
                            ...
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input id="email" name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="{{ 'email@gmail.com' }}" autocomplete="email" autofocus value="{{ old('email') }}" minlength="5" maxlength="191">
                            </div>
