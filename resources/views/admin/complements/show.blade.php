...
@section('title', 'Información del Complemento')
		...
		<div class="user-profile layout-spacing">
			<div class="widget-content widget-content-area">
				<div class="d-flex justify-content-between">
					<h3 class="">Datos del Complemento</h3>
					...
					<div class="row">
						<div class="col-12">
							<ul class="contacts-block list-unstyled mw-100 mx-2 mt-0">
								<li class="contacts-block__item">
									<span class="h6 text-black"><b>Precio:</b> {{ number_format($complement->price, 2, ',', '.') }}</span>
								</li>
								<li class="contacts-block__item">
									<span class="h6 text-black"><b>Descripción:</b> @if(!is_null($complement->description)){{ $complement->description }}@else{{ 'No Ingresado' }}@endif</span>
								</li>
								<li class="contacts-block__item">
