...
@section('title', 'Complement Information')
...
<div class="row">
		...
		<div class="user-profile layout-spacing">
			<div class="widget-content widget-content-area">
				<div class="d-flex justify-content-between">
					<h3 class="">Complement Information</h3>
	...
	<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 layout-top-spacing">
		...
		<div class="user-profile layout-spacing">
			<div class="widget-content widget-content-area">
				<div class="d-flex justify-content-between">
					<h3 class="pb-3">Additional Information</h3>
				</div>
				<div class="user-info-list">
					<div class="row">
						<div class="col-12">
							<ul class="contacts-block list-unstyled mw-100 mx-2 mt-0">
								<li class="contacts-block__item">
									<span class="h6 text-black"><b>Price:</b> {{ number_format($complement->price, 2, ',', '.') }}</span>
								</li>
								<li class="contacts-block__item">
									<span class="h6 text-black"><b>Description:</b> @if(!is_null($complement->description)){{ $complement->description }}@else{{ 'Not Added' }}@endif</span>
								</li>
								<li class="contacts-block__item">
