						...
						<form action="{{ route('agencies.store') }}" method="POST" class="form" id="formAgency">
							...
							<div class="row">
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<input class="form-control @error('route') is-invalid @enderror" type="text" name="route" required placeholder="Enter a route" value="{{ old('route') }}">
								</div>
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										<button type="submit" class="btn btn-primary" action="agency">Save</button>
