					...
					<div class="row">
						<div class="col-12">
							<ul class="contacts-block list-unstyled mw-100 mx-2 mt-0">
								<li class="contacts-block__item">
									<span class="h6 text-black"><b>Price:</b> {{ number_format($product->price, 2, ',', '.') }}</span>
								</li>
								<li class="contacts-block__item">
									<span class="h6 text-black"><b>Description:</b> @if(!is_null($product->description)){{ $product->description }}@else{{ 'Not Added' }}@endif</span>
								</li>
								<li class="contacts-block__item">
