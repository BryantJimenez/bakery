...
<div class="row">
		...
		<div class="user-profile layout-spacing">
			<div class="widget-content widget-content-area">
				<div class="d-flex justify-content-between">
					<h3 class="">Datos del Producto</h3>
					@can('products.edit')
	...
	<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 layout-top-spacing">
		...
		<div class="user-profile layout-spacing">
			<div class="widget-content widget-content-area">
				<div class="d-flex justify-content-between">
					<h3 class="pb-3">Información Adicional</h3>
				</div>
				<div class="user-info-list">
					<div class="row">
						<div class="col-12">
							<ul class="contacts-block list-unstyled mw-100 mx-2 mt-0">
								<li class="contacts-block__item">
									<span class="h6 text-black"><b>Precio:</b> {{ number_format($product->price, 2, ',', '.') }}</span>
								</li>
								<li class="contacts-block__item">
									<span class="h6 text-black"><b>Descripción:</b> @if(!is_null($product->description)){{ $product->description }}@else{{ 'No Ingresado' }}@endif</span>
								</li>
								<li class="contacts-block__item">
									<span class="h6 text-black"><b>Categoria:</b> @if(!is_null($product['category'])){{ $product['category']->name }}@else{{ 'No Ingresado' }}@endif</span>
								</li>
								<li class="contacts-block__item">
									<span class="h6 text-black"><b>Nº Grupos:</b> {{ $product['groups']->count() }}</span>
								</li>
								<li class="contacts-block__item">
