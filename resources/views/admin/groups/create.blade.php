...
@section('title', trans('admin.groups.titles.create'))
			...
			<div class="widget-header">
				<div class="row">
					<div class="col-xl-12 col-md-12 col-sm-12 col-12">
						<h4>@lang('admin.groups.titles.create')</h4>
					</div>                 
				</div>
			</div>
							...
							<div class="row">
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<select class="form-control @error('condition') is-invalid @enderror" name="condition" required>
										<option value="1" @if(old('condition')=="1") selected @endif>@lang('admin.values_attributes.conditions.required')</option>
										<option value="0" @if(old('condition')=="0") selected @endif>@lang('admin.values_attributes.conditions.optional')</option>
									</select>
								</div>

								<div class="form-group col-lg-6 col-md-6 col-12">
									<label class="col-form-label">@lang('form.minimum.label')<b class="text-danger">*</b></label>
									<input class="form-control int-max-100 @error('min') is-invalid @enderror" type="text" name="min" required placeholder="@lang('form.minimum.placeholder')" value="@if(!is_null(old('min'))){{ old('min') }}@else{{ '0' }}@endif">
								</div>

								<div class="form-group col-lg-6 col-md-6 col-12">
									<label class="col-form-label">@lang('form.maximum.label')<b class="text-danger">*</b></label>
									<input class="form-control int-max-100 @error('max') is-invalid @enderror" type="text" name="max" required placeholder="@lang('form.maximum.placeholder')" value="@if(!is_null(old('max'))){{ old('max') }}@else{{ '0' }}@endif">
								</div>
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										<button type="submit" class="btn btn-primary" action="group">@lang('form.buttons.save')</button>
